...
let currentPhoto = 0;
let imagesData = [data1.photo, data2.photo, data3.photo, data4.photo, data5.photo, data6.photo]
let titleData = [data1.title, data2.title, data3.title, data4.title, data5.title, data6.title]
let textData = [data1.text, data2.text, data3.text, data4.text, data5.text, data6.text]

$('#picture').attr('src',imagesData[currentPhoto]);
$('#title').text(titleData[currentPhoto]);
$('#text').text(textData[currentPhoto]);


let loadPhoto = (photoNumber) => {
    $('#picture').attr('src', imagesData[photoNumber]);
    $('#title').text(titleData[photoNumber]);
    $('#text').text(textData[photoNumber]); 
}
